...
!----------------------------
    INTEGER(KIND=I4)    , PARAMETER :: NSUB = 10
...
!------------------------------------
    ...
    INTEGER(KIND=I4)    , PARAMETER :: IM   = 401/10+1
...
!---------------------------          
    INTEGER(KIND=I4)    , PARAMETER :: LM   = 50
...
! RESTART:
!---------------------------
!    INTEGER(KIND=I4)    , PARAMETER :: outnum=120      ! number of outputs
!    INTEGER(KIND=I4)    , PARAMETER :: nday=30          ! number of days
